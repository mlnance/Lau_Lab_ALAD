...
if calc_nn:
  print "calc nn cycle: %s period_cycle: %s period: %s max_point: %s"
  %( cycle, period_cycle, period, max_point )
  ...
  print "no calc nn cycle: %s period_cycle: %s period: %s max_point: %s"
  %( cycle, period_cycle, period, max_point )
