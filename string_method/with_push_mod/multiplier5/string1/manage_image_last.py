...
#-------------------------#
# testing 4/18/2017 - Morgan Nance
# push along normal modification
# 50% of the time, push the string along its normal axis
if random.choice( [0,1] ):
  print "Pushing string along normal"
  # for general, -180,180 strings
  os.system('./push_string.py string_%s.dat > string_normal_%s.dat'
            %( cycle, cycle ) )
  # for strings that cross the boundary
