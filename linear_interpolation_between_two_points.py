...
'''
Give me two points( phi1, psi1 ) and ( phi2, psi2 ) and a number of steps to get between these points and this will return a set of phi,psi steps in a coords_<steps>steps.csv file
...
#print "\n".join( [ "%s,%s" %( coord[0], coord[1] ) for coord in phi_psi_coords ] )

# dump a coords_<steps>steps.csv in the cwd
#with open( "coords_%ssteps.csv" %steps, 'w' ) as fh:
#    writer = csv.writer( fh )
#    writer.writerow( [ "phi", "psi" ] )
#    writer.writerows( phi_psi_coords )
